...
import WholesalerShipModel from "../subComponents/WholesalerShipModel";
import WholesalerReceiveModel from "../subComponents/WholesalerReceiveModel";
import $ from 'jquery';
...
export default function WholesalerDashboard() {
    ...
    return (
        <>
                                            ...
                                            {/*     {drugDetList.map((drug, index) => {
                                                    return (
                                                        <tr key={index}>
                                                            ...
                                                            {!isOverview && <td><span className="complete">Complete</span></td>}
                                                            {!isOverview && <td><span className="complete">Complete</span></td>}
                                                            {!isOverview && <td><span className="complete">Complete</span></td>}
                                                            {!isOverview && <td><span className="processing">Processing</span></td>}
            ...
            { <WholesalerReceiveModel id="receive-product" selectedDrugDetails={selectedDrugDetails} updateReceiving={updateReceiving} /> }
                </div>

                <div className="model-section">
                   {  <WholesalerShipModel id="shipped-product" selectedDrugDetails={selectedDrugDetails} updateShipment={updateShipment} /> }
                </div>
