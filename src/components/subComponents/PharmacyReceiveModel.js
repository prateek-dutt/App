...
export default function PharmacyReceiveModel(props)
{
   ...
   // const [destinationUName, setDestinationUName] = useState(null);
    ...
    async function processReceiving(drug)
    {
        ...
        await fetch(localhost+"PharmacyReceiving",{
            method:"POST",
                   ...
                   {/*  <div className="row mb-2">
                    ...
                    <div className="row mb-2">
                        <div className="col-12 text-end">
                            <button className="btn btn-primary" type="button" data-bs-dismiss="modal" onClick={(e) => { processReceiving(selectedDrugDetails) }}>Receive</button>
                        </div>
                    </div>
                </form>
            </div>
