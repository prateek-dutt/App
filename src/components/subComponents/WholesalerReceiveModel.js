...
export default function WholesalerReceiveModel(props)
{
   ...
   // const [destinationUName, setDestinationUName] = useState(null);
    ...
    async function processReceiving(drug)
    {
        ...
        await fetch(localhost+"WholesalerReceiving",{
            method:"POST",
            ...
            <div className="modal-body">
                <form className=" g-3 helvetica-light sub-color">
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-12 col-md-6">
                            <label htmlFor="source" className="form-label">Location</label>
                            <select id="source" className="form-select" disabled>
                                <option defaultValue={selectedDrugDetails.nextOwner}>{selectedDrugDetails.nextOwner}</option>
                            </select>
                        </div> 
                    </div>
                    <div className="row  mb-2">
