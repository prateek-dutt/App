...
export default function WholesalerShipModel(props)
{

    const { selectedDrugDetails} = props;
    const [destination, setDestination] = useState("Distributor");
    ...
    const resetFields = () => {
        ...
        $("#shipped-product").children("input").value=null;
        ...
        let post={
         ...
         //   "PharmacyUserName": "Teja",
           // "ExportTemp": 7
            ...
            "PharmacyUserName":destinationUName,
            //"DistributorUserName":destinationUName,
            "ExportTemp":exportingTemp
        }
        console.log(post);
         fetch(localhost+"WholesalerrShipping",{
            method:"POST",
            ...
            <div className="modal-content p-3">
                ...
                <div className="modal-body">
                    <form className=" g-3 helvetica-light sub-color">
                        ...
                        <div className="row mb-2">
                            <div className="col-12 col-md-6">
                                <label htmlFor="destinationUName" className="form-label">Pharmacy Username</label>
